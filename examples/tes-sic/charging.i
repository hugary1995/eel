...
[Postprocessors]
  ...
  [TC1]
    type = PointValue
    variable = T
    point = '0.02 ${fparse 0.03730625+0.0762} 0'
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [TC2]
    type = PointValue
    variable = T
    point = '0.027 ${fparse 0.0746125+0.0762} 0'
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [TC3]
    type = PointValue
    variable = T
    point = '0.034 ${fparse 0.11191875+0.0762} 0'
    execute_on = 'INITIAL TIMESTEP_END'
  []
[]
