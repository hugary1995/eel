...
// Induction coils
For i In {1:n_coil}
  Rectangle(100+i) = {coil_R-coil_w/2, coil_y, 0, coil_w, coil_t, 0};
  coil_y = coil_y+coil_t+coil_S;
EndFor

// Air
Rectangle(200) = {0, 0, 0, air_R, pipe_H, 0};

// Fragments
s() = BooleanFragments{ Surface{200}; Delete; }{ Surface{1:7, 101:(100+n_coil)}; Delete; };
...
Physical Surface("insulation") = {117};
Physical Surface("fbrick") = {4};
Physical Surface("container") = {116};
Physical Surface("medium") = {7};
Physical Surface("air") = {115, 118};
Physical Surface("coil") = {101:114};
