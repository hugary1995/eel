...
if __name__ == "__main__":
    ...
    parser.add_argument("--spacing-min", default=0.025, type=float)
    parser.add_argument("--spacing-max", default=0.25, type=float)
    parser.add_argument("--num-points", default=40, type=int)
